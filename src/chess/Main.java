...
public class Main {
	...
	// how will we run everything, keep track of whose turn?, capture input for promotion and turns?, will it be efficient enough,
	// is it useful to create a Board class? Maybe poitions will have stored a pointer to a figure thats standing there
	// will we need a player class for running everything and keep track of possible time / timer?
